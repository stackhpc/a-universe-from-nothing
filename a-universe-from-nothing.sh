...
# Clone Kayobe.
[[ -d kayobe ]] || git clone https://git.openstack.org/openstack/kayobe.git -b stable/stein
cd kayobe

# Clone this Kayobe configuration.
mkdir -p config/src
cd config/src/
[[ -d kayobe-config ]] || git clone https://github.com/stackhpc/a-universe-from-nothing.git -b stable/stein kayobe-config
