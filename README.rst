...
.. code-block:: console
   ...
   # Clone Kayobe.
   git clone https://opendev.org/openstack/kayobe.git -b stable/xena
   cd kayobe
   ...
   mkdir -p config/src
   cd config/src/
   git clone https://github.com/stackhpc/a-universe-from-nothing.git kayobe-config -b stable/xena
...
.. code-block:: console
    ...
    304b197f888b        192.168.33.5:4000/kolla/centos-source-kibana:xena                     "dumb-init --single-c"   18 minutes ago      Up 18 minutes                           kibana
    9eb0cf47c7f7        192.168.33.5:4000/kolla/centos-source-elasticsearch:xena              "dumb-init --single-c"   18 minutes ago      Up 18 minutes                           elasticsearch
    ...
...
.. code-block:: console
    ...
    pip install python-barbicanclient -c https://releases.openstack.org/constraints/upper/xena
