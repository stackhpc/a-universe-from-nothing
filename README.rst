...
.. code-block:: console
   ...
   [[ -d deployment ]] || beokay/beokay.py create --base-path ~/deployment --kayobe-repo https://opendev.org/openstack/kayobe.git --kayobe-branch stable/2025.2 --kayobe-config-repo https://github.com/stackhpc/a-universe-from-nothing.git --kayobe-config-branch stable/2025.2
...
.. code-block:: console
    ...
    fad79f29afbc   192.168.33.5:4000/openstack.kolla/opensearch-dashboards:2025.2-rocky-9       "dumb-init --single-…"   6 hours ago   Up 6 hours (healthy)             opensearch_dashboards
    64df77adc709   192.168.33.5:4000/openstack.kolla/opensearch:2025.2-rocky-9                  "dumb-init --single-…"   6 hours ago   Up 6 hours (healthy)             opensearch
...
.. code-block:: console
    ...
    pip install python-barbicanclient -c https://releases.openstack.org/constraints/upper/2025.2
